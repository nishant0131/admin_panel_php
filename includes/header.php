...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>Administrator Portal | Dashboard</title>
...
<div class="navbar-inner">
    ...
    <a class="navbar-brand" href="index.php"> <img alt="Cynoteck Logo" src="assets/img/logo20.png" class="hidden-xs"/>
        <span>Cynoteck</span></a>
